...
export interface ProductModelList {
  [uid: string]: ProductModel
}
export class ProductsMocakupData {
    static data: ProductModelList = {
        '62122871cb242f1f01d916f9': {
          brand: 'puma',
          category: 'tshirt',
          color: 'brown',
          gender: 'unisex',
